...
def get_quote():
    ...
    jma_return = ['明日の天気予報--南部--',jma_place,"予報取得時刻  "+jma_timeget,"予報時刻  "+jma_date,jma_weather,'最高気温  '+jma_temp+'℃','データーは気象庁より']
    return('\n'.join(jma_return))
#警報をいただくぜ
#!/usr/bin/env python3
...
WEATHER_TRANS = json.load(open(base + "/transweather.json", "r",encoding="utf-8"))
